...
<!-- Hero Section -->
<section class="relative h-screen bg-cover bg-center" style="background-image: url({{ $homeContent->hero_image }})">
...
<section class="relative -mt-20">
    <div class="max-w-6xl mx-auto bg-white rounded-xl shadow-lg px-12 py-12 grid md:grid-cols-5 gap-8">
  ...
  <section class="bg-[#EAF6FF] py-16 mt-9 relative">
...
<section id="galeri" class="py-16 bg-white text-center">
    <div class="max-w-6xl mx-auto px-4">
        <p class="text-yellow-500 font-semibold tracking-widest mb-2">GALERI</p>
        <h2 class="text-3xl font-bold mb-10">Galeri - Galeri Foto</h2>
...
<section id="galeri-video" class="py-16 bg-white text-center">
    <div class="max-w-4xl mx-auto px-4">
        <p class="text-yellow-500 font-semibold tracking-widest mb-2">GALERI</p>
        <h2 class="text-3xl font-bold mb-10">Galeri - Galeri Video</h2>
